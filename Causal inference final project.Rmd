...
```{r Unjusted method, message=FALSE, warning=FALSE}
#Unjusted method
Unjusted<-plasma %>%
...
```{r Regression adjusted, message=FALSE, warning=FALSE}
#Regression adjusted
...
```{r PS Regression Adjustment, message=FALSE, warning=FALSE, include=FALSE}
...
```{r Propensity Scores Stratification, message=FALSE, warning=FALSE, include=FALSE}
...
te_quintile02 <- tapply(plasma$betaplasma[plasma$vituse == 2], ps2_quintile[plasma
$vituse == 2], mean) - tapply(plasma$betaplasma[plasma$vituse == 0], ps0_quintile[plasma$vituse == 0], mean)
...
ATE_PSS_01.boot <- (te_quintile01.boot *nj1.boot/n+te_quintile01.boot *nj0.boot/n)/
2
ATE_PSS_02.boot <- (te_quintile02.boot *nj2.boot/n+te_quintile02.boot *nj0.boot/n)/
2
}
...
```{r Inverse Probability Weighting (IPW2), message=FALSE, warning=FALSE}
